...
public:
	...
	void EXPORT BounceKick( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value );
...
#define MP5_MAX_CLIP			30 // YELLOWSHIFT Adjusted to 30, Default Ammo adjusted to 15.
...
public:
	...
	void Attack( void );
	void PrimaryAttack( void );
	void SecondaryAttack( void );// YELLOWSHIFT
	void WeaponIdle( void );
